...
def open_live_weather_page():
    import subprocess
    subprocess.Popen(["python", "application.pyw"])        
...
w = tk.Label(root, text="Spatial feature attention based LSTM model\n for short term predictions",width=60,background="#87CEEB",fg="black", height=2,font=("Times new roman",27,"bold"))
w.place(x=1,y=1)
...
live_weather_button = tk.Button(frame_alpr, text="Live Weather", command=open_live_weather_page)
live_weather_button.grid(row=2, column=0, columnspan=2, padx=10, pady=10)
