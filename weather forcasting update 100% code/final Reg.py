...
label=tk.Label(root,text="Spatial feature attention based LSTM model\n for short term predictions ",font=("Calibri",40),
               bg="#8DB6CD",
               width=60,
               height=2)
label.place(x=0,y=0)        
